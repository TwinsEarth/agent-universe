...
> **成品下载**：`.msi` / NSIS `.exe` 由 CI（`.github/workflows/client-build.yml`）在打版本 tag 时自动构建并发布到 [GitHub Release](https://github.com/TwinsEarth/agent-universe/releases/tag/v2.3.6)，可直接下载。以下为本地手动构建步骤。
